...
- [ ] Implementar funções de rotação, escalonamento e outras distorções para aplicar nos polígonos.
- [ ] Implementar o sistema básico de física e input e testá-los em conjunto.
