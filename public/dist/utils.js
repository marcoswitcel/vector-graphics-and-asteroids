 ...
 */
export function createCanvas(width, height, appendTo) {
 ...
 */
export function renderFigureInside(entity, figure, ctx, drawFunction) {
 ...
 */
export function computeResolution(factor = 1) {
...
export function countEntitiesByType(entities, type) {
